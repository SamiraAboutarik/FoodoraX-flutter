...
class _FoodDetailsScreenState
  ...
  bool get isFavorite =>
      widget.favoriteIds.contains(widget.food.id);

  void _toggleFavorite() {
    widget.onToggleFavorite(widget.food.id);
    setState(() {});
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (final ing in ingredientsFor(food.category)) _ingredient(ing.icon, ing.name),
                  const SizedBox(height: 25),
